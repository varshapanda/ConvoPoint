...
export const createVerificationEmailTemplate = (name, token, clientURL) => {
  ...
  <head>
    ...
    <title>Verify Your Email - ConvoPoint</title>
  </head>
  <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #ececec; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #0d0d0d;">
    ...
    <div style="background-color: #1a1a1a; padding: 40px 35px; border-radius: 0 0 8px 8px; box-shadow: 0 2px 12px rgba(0,0,0,0.5); border: 1px solid #2d2d2d; border-top: none;">
      ...
      <p style="color: #b4b4b4; font-size: 15px; line-height: 1.6; margin-bottom: 24px;">Thank you for signing up for ConvoPoint! We're excited to have you join our messaging platform.</p>
      
      <p style="color: #b4b4b4; font-size: 15px; line-height: 1.6; margin-bottom: 24px;">To complete your registration and start connecting with friends, family, and colleagues, please verify your email address by clicking the button below:</p>
      
      <div style="text-align: center; margin: 32px 0;">
        <a href="${safeLink}" target="_blank" rel="noopener noreferrer" style="background: linear-gradient(135deg, #ffffff 0%, #e0e0e0 100%); color: #0d0d0d; text-decoration: none; padding: 14px 32px; border-radius: 6px; font-weight: 600; font-size: 15px; display: inline-block; box-shadow: 0 2px 12px rgba(255,255,255,0.2); transition: all 0.2s;">Verify Email Address</a>
      </div>
      
      <div style="background-color: #0d0d0d; padding: 20px; border-radius: 8px; margin: 28px 0; border: 1px solid #2d2d2d;">
        <p style="color: #b4b4b4; font-size: 14px; margin: 0 0 12px 0;">Or copy and paste this link into your browser:</p>
        <p style="color: #ffffff; font-size: 13px; word-break: break-all; margin: 0;">${safeLink}</p>
      </div>
      
      <div style="margin-top: 32px; padding-top: 24px; border-top: 1px solid #2d2d2d;">
        <p style="margin-bottom: 8px; color: #b4b4b4; font-size: 14px;">This verification link will expire in 24 hours.</p>
        <p style="margin-top: 0; color: #b4b4b4; font-size: 14px;">If you didn't create an account with ConvoPoint, you can safely ignore this email.</p>
      </div>
